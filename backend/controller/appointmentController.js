...
export const postAppointment = catchAsyncError(async (req, res, next) => {
    const { firstName, lastName, email, phone, Aadhar, dob, gender, appointment_date, department,
    ...
    const appointment = await Appointment.create({
        firstName, lastName, email, phone, Aadhar, dob, gender, appointment_date, department,
        doctor: {
            firstName: doctor_firstName,
            lastName: doctor_lastName,
        },
